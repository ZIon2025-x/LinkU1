...
/// Applications tab — self-contained version of the expert applications list.
///
/// Reads the current expert id from [SelectedExpertCubit] and provides its own
/// [TaskExpertBloc]. The [BlocProvider] is keyed by `expertId` so switching the
/// selected team rebuilds the subtree.
