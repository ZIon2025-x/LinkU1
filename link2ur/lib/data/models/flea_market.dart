...
class FleaMarketItem extends Equatable {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'days_until_auto_delist': daysUntilAutoDelist,
      'pending_payment_task_id': pendingPaymentTaskId,
      'pending_payment_client_secret': pendingPaymentClientSecret,
      'pending_payment_amount': pendingPaymentAmount,
      'pending_payment_amount_display': pendingPaymentAmountDisplay,
      'pending_payment_currency': pendingPaymentCurrency,
      'pending_payment_customer_id': pendingPaymentCustomerId,
      'pending_payment_ephemeral_key_secret': pendingPaymentEphemeralKeySecret,
      'pending_payment_expires_at': pendingPaymentExpiresAt,
      'is_available': isAvailable,
      'user_purchase_request_id': userPurchaseRequestId,
      'user_purchase_request_status': userPurchaseRequestStatus,
      'user_purchase_request_proposed_price': userPurchaseRequestProposedPrice,
      'my_role': myRole,
