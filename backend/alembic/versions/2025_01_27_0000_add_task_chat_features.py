...
# 基于两个已迁移的分支：add_pending_user_table 和 make_task_history_nullable
down_revision: Union[str, Sequence[str], None] = ('add_pending_user_table', 'make_task_history_nullable')
