...
SMOKE_PROBES: list[tuple[str, str, str, tuple[int, ...], tuple[str, ...]]] = [
    ...
    # /api/services is intentionally public (no auth) — 401 here would mean
    # someone accidentally added Depends(get_current_user); keep it out of the allowlist.
    ("service_public",  "GET",  "/services",              (200, 500),       _API_ONLY),
]
