...
async def create_post(
    ...
    return schemas.ForumPostOut(
        ...
        category=schemas.CategoryInfo(id=db_post.category.id, name=db_post.category.name, name_en=db_post.category.name_en, name_zh=db_post.category.name_zh) if db_post.category else None,
        author=author_info,
