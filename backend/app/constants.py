...
#
# 城市筛选/别名映射统一放在 utils 中，避免在各处重复维护。
# 这里做 re-export，兼容历史 import 路径：from app.constants import UK_MAIN_CITIES / get_city_name_variants
#
from app.utils.city_filter_utils import (  # noqa: E402
    UK_MAIN_CITIES,
    CITY_NAME_MAPPING,
    CITY_NAME_REVERSE_MAPPING,
    get_city_name_variants,
)
