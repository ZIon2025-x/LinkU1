...
class StringValidator(BaseValidator):
    ...
    def normalize_phone(phone: str) -> str:
        ...
        - +33 06 12345678 → +33612345678
        - +49 0170 1234567 → +491701234567
        - 07123456789    → +447123456789（无区号、0 开头 → 英国号码）
        - 空字符串       → ""（不变，用于解绑场景）
        """
        ...
        # 常见欧洲区号后面的前导0（如 +440xxx, +330xxx, +490xxx 等）
        phone = re.sub(
            r'^\+(44|33|49|34|39|31|32|43|353|351|30|46|45|358|47|48|420|41)0',
            r'+\g<1>',
            phone,
        )
        return phone
