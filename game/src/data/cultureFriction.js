  ...
  uni: [
    {
      ...
      choices: [
        { label: '"China. I just said." 直接', effect: { energy: -3, belonging: 4, flag: 'pushed_back' },
          feedback: '她笑了 3 秒后改口："Right, of course. Sorry, daft question."\n\n气氛尴尬。但你想：我没有错。她问的是我"真的"从哪——好像 China 不算真的。\n\n这是你这一年第一次顶回去。' },
        { label: '解释一遍 我从北京 / 上海来的', effect: { energy: -1 },
        ...
        { label: '装作没听懂 笑笑过去', effect: { energy: 1, belonging: -3 },
    ...
    },
    {
      ...
      choices: [
        { label: '"我不能代表 14 亿人"', effect: { energy: -5, academic: 3, belonging: 6, flag: 'refused_proxy' },
          ...
          { label: '硬着头皮讲', effect: { energy: -8, academic: 1, belonging: -3 },
  ...
  pub: [
    {
      ...
      choices: [
        { label: '装作没听见 喝完酒走', effect: { energy: -8, belonging: -8 },
          feedback: '你 10 分钟内喝完一杯 cider，付钱走了。\n\n回家路上你大脑一直在播放那句话。你不知道你应该不应该说什么。但你也知道——4 个英国醉汉对一个外国学生，你说什么都没用。\n\n这是英国留学生不告诉父母的那种夜晚。' },
        { label: '直接问 "Sorry, are you talking about me?"', effect: { energy: -10, belonging: 5, flag: 'confronted' },
          feedback: '4 个人转头看你 3 秒。最响那个红了脸："No no, just talking about general stuff."\n\n气氛冻住。你站起来付了钱走了——没等回应。\n\n你不知道你赢了还是输了。但你说出口了。' },
        { label: '在 CSSA 群里发吐槽', effect: { energy: -3, belonging: 2 },
  ...
  flat: [
    {
      ...
      choices: [
        { label: '问 agent "Was it because I\'m a foreign student?"', effect: { energy: -5, belonging: -3, flag: 'asked_landlord' },
    ...
    },
    {
      ...
      choices: [
        { label: '小声纠正他："It\'s Chen / Wang / Lin actually"', effect: { energy: -2, belonging: 2 },
          feedback: '他："Oh sorry mate. Chen. Got it." 然后他真的记住了——下次他直接说 "Mate, package for Chen!"\n\n你这一瞬间觉得——纠正一次比生气一次值。' },
        { label: '"It\'s fine" 拿了走', effect: { energy: -3, belonging: -2 },
