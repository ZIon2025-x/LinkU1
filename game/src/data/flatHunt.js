  ...
  flat: [
    {
      ...
      choices: [
        { label: '锁定 5 套 周末看', effect: { energy: -5, flag: 'flat_shortlist' },
    ...
    },
    {
      ...
      choices: [
        { label: '当场 hold 这套（押金 £200）', effect: { wallet: -200, energy: -8, flag: 'held_first_flat' },
    ...
    },
    {
      ...
      choices: [
        { label: '邮件追问 specific reasons', effect: { energy: -5, belonging: -2, flag: 'asked_landlord' },
    ...
    },
    {
      ...
      choices: [
        { label: '认真打包 + 跟 housemate 抱别', effect: { wallet: -260, energy: -15, belonging: 18 },
        ...
        { label: '一个人默默搬', effect: { wallet: -260, energy: -20, belonging: -3 },
