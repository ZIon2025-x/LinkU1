...
export const DAILY_LIFE_EVENTS = {
  ...
  flat: [
    ...
    },
    {
      ...
      choices: [
        { label: '默默站雨里 20 分钟', effect: { energy: -10, belonging: 4, stress: 6, flag: 'fire_alarm_witnessed' },
    ...
    },
    {
      ...
      choices: [
        { label: '报修 Estates 邮件', effect: { energy: -3, stress: 4, flag: 'maintenance_filed' },
        ...
        { label: '搬到图书馆', effect: { academic: 5, energy: -5, stress: 2 },
          feedback: '你打包 laptop + 充电器去 24 小时图书馆。比公寓暖。\n\n那一周你的论文 outline 比谁都齐。冷的时候，伦敦图书馆是最便宜的暖气。' },
        { label: '多盖被子撑', effect: { energy: -8, belonging: -3, stress: 8 },
