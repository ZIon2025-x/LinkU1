  ...
  flat: [
    {
      ...
      choices: [
        { label: '坚持先视频看房 + 验房东 BRP', effect: { energy: -3, belonging: 6, stress: 4, flag: 'scam_deposit_resisted' },
        ...
        { label: '"急于 secure" + 转 £400', effect: { wallet: -400, energy: -8, belonging: -6, stress: 16, flag: 'scammed_deposit' },
        ...
        { label: '"算了" 关闭 Gumtree 找正规中介', effect: { energy: 1, stress: 1 },
  ...
  uni: [
    {
      ...
      choices: [
        ...
        { label: '付 £800 + 让中介帮处理', effect: { wallet: -800, energy: -10, belonging: -8, stress: 20, flag: 'scammed_psw_agent' },
    ...
    },
    {
      ...
      choices: [
        ...
        { label: '"听起来合理" 付 £2,000', effect: { wallet: -2000, energy: -20, belonging: -15, stress: 25, flag: 'scammed_sponsor_full' },
