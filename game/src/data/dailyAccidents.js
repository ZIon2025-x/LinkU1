...
export const DAILY_ACCIDENT_EVENTS = {
  ...
  flat: [
    ...
    },
    {
      ...
      choices: [
        { label: '在 GOV.UK 上 claim refund', effect: { energy: -5, wallet: 80, academic: 3 },
        ...
        { label: '"算了 £80 而已"', effect: { energy: 1 },
    ...
    },
    {
      ...
      choices: [
        { label: '认真 dispute + 提供 smart meter readings', effect: { energy: -8, wallet: 60, academic: 2, flag: 'gas_disputed' },
        ...
        { label: '"算了 直接 paid"', effect: { wallet: -140, energy: 0 },
    ...
    },
    {
      ...
      choices: [
        { label: '认真描述症状 + 跟流程走', effect: { energy: -3, belonging: 6, flag: 'nhs_111_used' },
        ...
        { label: '"算了 我自己睡一下"', effect: { energy: -8, belonging: -3 },
    ...
    // ─── 银行/手续 (b) ───
    {
      ...
      choices: [
        { label: 'app 内 chat verify + 解封 (15 分钟)', effect: { energy: -3, wallet: -8, belonging: 1, flag: 'monzo_verified' },
        ...
        { label: '"靠" 放下东西回 ensuite', effect: { energy: -3, belonging: -3 },
    ...
    },
    {
      ...
      choices: [
        { label: '在 Camden Council 网站 file student exemption', effect: { energy: -3, academic: 2, belonging: 4, flag: 'council_tax_filed' },
        ...
        { label: '"我 student 我不交" 不管', effect: { wallet: -100, energy: -8, belonging: -5 },
    ...
    },
    {
      ...
      choices: [
        { label: '打国内 Lloyds 客服 + WeChat 改', effect: { energy: -8, wallet: -3, academic: 1, flag: 'lloyds_recovered' },
        ...
        { label: '激活国内号漫游', effect: { wallet: -50, energy: -3 },
    ...
    },
    {
      ...
      choices: [
        { label: '在街上跟 Sarah 一起骂 Tom', effect: { energy: -3, belonging: 6, wallet: -3 },
        ...
        { label: '冷得不行 + 去 Pret 买热咖啡', effect: { wallet: -4, energy: 3 },
        ...
        { label: '"我不下楼"（回床躺）', effect: { energy: -8, belonging: -5 },
    ...
    // ─── 室友 micro 摩擦 (h) ───
    {
      ...
      choices: [
        ...
        { label: '生闷气 + 默默在 fridge 贴更狠 label', effect: { energy: -5, belonging: -3 },
    ...
    },
    {
      ...
      choices: [
        { label: '让他进 + 第二天跟 Sarah 提', effect: { energy: -8, belonging: 2 },
        ...
        { label: '让他进 + 心里默默生气', effect: { energy: -10, belonging: -3 },
        ...
        { label: '"Sarah\'s asleep mate" 直接关门', effect: { energy: -3, belonging: -5 },
    ...
    },
    {
      ...
      choices: [
        { label: '"It\'s fine but BRP letters please leave sealed"（明确边界）', effect: { energy: 1, belonging: 3 },
        ...
        { label: '"That\'s a legal immigration document Sarah"（沉下脸）', effect: { energy: -3, belonging: -3 },
