...
export const LINK2UR_ACCEPT_TEMPLATES = [
  ...
  {
    id: 'l2u_ai_short_video_localization', type: 'ai_video_short', emoji: '📱',
    titles: ['AI 短视频本地化改版', '留学生向短视频 UK 本地化剪辑'],
    desc: '客户有国内抖音素材要重剪成 UK 受众版。字幕节奏 + 配乐 + 文案全部本地化。',
    rewardMin: 50, rewardMax: 90,
    energyCost: 8, actionCost: 1,
    minWeek: 2, maxWeek: 30,
    rating: 5,
    phase: 1,
    customerAffinityType: 'ai_video_short',
  },
  {
    id: 'l2u_ai_xhs_content_pack', type: 'ai_xhs_content', emoji: '📕',
    titles: ['小红书内容包 × 5 篇', 'AI 辅助小红书图文 5 条'],
    desc: '客户刚开小红书账号推 UK 留学服务。5 篇图文 + 标签策略 + 封面设计。',
    rewardMin: 80, rewardMax: 200,
    energyCost: 10, actionCost: 1,
    minWeek: 4, maxWeek: 30,
    rating: 5,
    phase: 1,
    customerAffinityType: 'ai_xhs_content',
  },
  {
    id: 'l2u_ai_ig_visual_set', type: 'ai_ig_visual', emoji: '📸',
    titles: ['Instagram 视觉套组 9 宫格', 'IG 留学生账号视觉风格包'],
    desc: '客户要打造留学生 lifestyle IG 账号。Canva + AI 生成统一 feed 风格，9 张首页视觉。',
    rewardMin: 60, rewardMax: 150,
    energyCost: 9, actionCost: 1,
    minWeek: 2, maxWeek: 30,
    rating: 5,
    phase: 1,
    customerAffinityType: 'ai_ig_visual',
  },
  {
    id: 'l2u_ai_student_showreel', type: 'ai_personal_brand', emoji: '🎞️',
    titles: ['留学生作品集 showreel 剪辑', 'AI 辅助个人品牌 showreel 1 分钟'],
    desc: '客户申请 internship，需要 1 分钟展示视频。把课程作品 + 社团活动剪成 showreel + VO 脚本。',
    rewardMin: 40, rewardMax: 180,
    energyCost: 12, actionCost: 1,
    minWeek: 6, maxWeek: 30,
    rating: 5,
    phase: 1,
    customerAffinityType: 'ai_personal_brand',
  },
  {
    id: 'l2u_ai_logo_brand_kit', type: 'ai_branding', emoji: '✏️',
    titles: ['AI 辅助 logo + 品牌 kit 设计', '留学生小团队 brand identity 包'],
    desc: '客户开留学服务小团队，需要 logo × 3 稿 + 色板 + 字体 + 名片模板。AI 出草稿 + 手工 refine。',
    rewardMin: 100, rewardMax: 400,
    energyCost: 14, actionCost: 1,
    minWeek: 8, maxWeek: 30,
    rating: 5,
    phase: 1,
    customerAffinityType: 'ai_branding',
    requirement: { count: 3 },
  },
  {
    id: 'l2u_ai_sora_30s_spec', type: 'ai_video_long', emoji: '🎥',
    titles: ['Sora 30 秒品牌视频 spec work', 'AI 视频生成 30s 广告片'],
    desc: '客户是中资 UK 品牌，要做 30 秒 awareness 视频测试 Sora pipeline。脚本 + prompting + 后期合成。',
    rewardMin: 600, rewardMax: 1500,
    energyCost: 20, actionCost: 1,
    minWeek: 23, maxWeek: 52,
    rating: 5,
    phase: 2,
    customerAffinityType: 'ai_video_long',
    requirement: { count: 5, rating: 4.5 },
  },
  {
    id: 'l2u_ai_meta_campaign', type: 'ai_ads_meta', emoji: '📣',
    titles: ['Meta 广告 campaign 全套搭建', 'Facebook + Instagram AI 广告投放'],
    desc: '客户进 UK launch，5 audience segment，14 天 ROAS 目标 3.5+。AI 生成 copy × 10 + 图素材 × 5 + 受众搭建。',
    rewardMin: 800, rewardMax: 2500,
    energyCost: 22, actionCost: 1,
    minWeek: 23, maxWeek: 52,
    rating: 5,
    phase: 2,
    customerAffinityType: 'ai_ads_meta',
    requirement: { count: 5, rating: 4.6 },
  },
  {
    id: 'l2u_ai_google_campaign', type: 'ai_ads_google', emoji: '🔍',
    titles: ['Google Ads campaign AI 全套', 'Search + Display AI 广告搭建'],
    desc: '客户中资留学服务机构，UK 搜索量核心词竞价。AI 生成 RSA ad copy × 15 + landing page optimization。',
    rewardMin: 600, rewardMax: 2000,
    energyCost: 20, actionCost: 1,
    minWeek: 23, maxWeek: 52,
    rating: 5,
    phase: 2,
    customerAffinityType: 'ai_ads_google',
    requirement: { count: 5, rating: 4.5 },
  },
  {
    id: 'l2u_ai_xhs_kol_match', type: 'ai_xhs_kol', emoji: '🌟',
    titles: ['小红书 KOL 匹配 + 合作方案', 'AI 辅助 KOL outreach × 20 人'],
    desc: '客户 UK 美妆 DTC 品牌要做小红书种草。AI 筛选 20 个留学生 KOL + 撰写合作 brief + 邮件模板。',
    rewardMin: 400, rewardMax: 1200,
    energyCost: 16, actionCost: 1,
    minWeek: 25, maxWeek: 52,
    rating: 5,
    phase: 2,
    customerAffinityType: 'ai_xhs_kol',
    requirement: { count: 3, rating: 4.5 },
  },
  {
    id: 'l2u_ai_bilingual_gtm', type: 'ai_gtm_strategy', emoji: '🗺️',
    titles: ['双语 GTM 策略文档', 'UK 入市双语 go-to-market 全案'],
    desc: '客户中资 SaaS 进 UK 市场。AI 辅助产出 30 页双语 GTM 文档：竞品分析 + ICP + channel mix + 季度 OKR。',
    rewardMin: 1000, rewardMax: 3000,
    energyCost: 25, actionCost: 1,
    minWeek: 30, maxWeek: 52,
    rating: 5,
    phase: 2,
    customerAffinityType: 'ai_gtm_strategy',
    requirement: { count: 8, rating: 4.7 },
  },
  {
    id: 'l2u_ai_dtc_listing', type: 'ai_dtc_listing', emoji: '🛒',
    titles: ['DTC 电商 listing AI 优化', 'Amazon UK + Shopify listing 双语改写'],
    desc: '客户中资品牌 UK Amazon 新店。AI 重写 10 个 SKU listing：标题 + 5 bullet + A+ content outline，中英双语。',
    rewardMin: 300, rewardMax: 800,
    energyCost: 14, actionCost: 1,
    minWeek: 25, maxWeek: 52,
    rating: 5,
    phase: 2,
    customerAffinityType: 'ai_dtc_listing',
    requirement: { count: 3, rating: 4.5 },
  },
  {
    id: 'l2u_ai_academic_proofread', type: 'ai_academic', emoji: '🔬',
    titles: ['AI 辅助学术论文校对', 'Dissertation AI proofreading + 语法精修'],
    desc: '客户用 AI 写了初稿但担心 AI tone 太重。人工 + AI 协作校对：grammar + academic register + citation format。',
    rewardMin: 50, rewardMax: 150,
    energyCost: 8, actionCost: 1,
    minWeek: 8, maxWeek: 52,
    rating: 5,
    phase: 'both',
    customerAffinityType: 'ai_academic',
  },
];
