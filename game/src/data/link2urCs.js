...
export const LINK2UR_CS_MESSAGES = [
  ...
  },
  {
    ...
    text:
      ...
      + '说一句不是管你——漏顿饭压力涨得最狠 (+8 点),'
      + '比 essay 没写完还狠。\n\n'
      + '即使是 Tesco Meal Deal £3.40——也比挨饿 + £15 外卖 + 8 点压力划算。',
  },
  {
    ...
    text:
      ...
      + '· 75-84:**每天只剩 2 个行动点**\n'
      + '· 85-94:**每天只剩 1 个行动点** + belonging/energy 重扣\n'
      + '· 95+:burnout 失败 ending\n\n'
      + '解压最快的两条路:发 Link2Ur post (每发一次 -18)、接单 (-12)。',
  },
];
