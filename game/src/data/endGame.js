...
export const END_GAME_EVENTS = {
  flat: [
    ...
    },
    {
      ...
      choices: [
        { label: '搬到 24h 图书馆 5 天不出门', effect: { energy: -25, academic: 12, belonging: -5, stress: 20, skipDays: 5, flag: 'thesis_grinded' },
          feedback: '你 5 天写了 6,800 字。睡 4 小时一晚。最后 24 小时你穿着 hoodie 看 Whitmore 的 latest feedback——他说 "You\'re close. Tighten the conclusion."\n\n你提交了。15,003 字。3 字超额。\n\n你回家洗了一个 40 分钟的澡。' },
        { label: '熬夜 + ChatGPT 帮草稿', effect: { energy: -15, academic: 5, stress: 12, skipDays: 3, flag: 'used_ai' },
        ...
        { label: '联系 supervisor 求 extension', effect: { energy: -3, academic: 0, stress: -3, flag: 'extension_filed' },
    ...
    },
    {
      ...
      choices: [
        { label: '寄全部 + 自己只带 1 个登机箱回', effect: { wallet: -400, energy: -8, belonging: 5, skipDays: 1 },
          feedback: '你打包到凌晨 2 点。每件衣服都让你想起一段——这件大衣是 Bonfire Night 那晚穿的、这双鞋走了 40 分钟到 Acton 取 BRP、这件毛衣是妈妈从国内寄来的。\n\n你封箱时眼眶有点红。这些不是衣服，是一年。' },
        { label: '简化 只寄 2 箱 (£200)', effect: { wallet: -200, energy: -3, belonging: 2, skipDays: 1 },
