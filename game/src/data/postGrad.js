...
export const POST_GRAD_EVENTS = {
  flat: [
    ...
    },
    {
      ...
      choices: [
        { label: '群里发 "恭喜！🎉"', effect: { energy: -2, belonging: 2, stress: 3 },
          feedback: '你点了 emoji，复制了 "恭喜恭喜！太厉害了！"\n\n关掉群你坐了 5 分钟。然后你打开 LinkedIn 投了 5 份简历——"今天必须做点什么"。\n\n不甘心也是一种生产力。' },
        { label: '私聊问他怎么拿的', effect: { energy: -3, belonging: 4, stress: 2 },
        ...
        { label: '关群 不看', effect: { energy: 1, belonging: -3, stress: 6 },
    ...
    },
    {
      ...
      choices: [
        { label: '认真讲一个真实经历（STAR 法）', effect: { energy: -8, academic: 3, stress: 8, flag: 'hirevue_done' },
        ...
        { label: 'Panic 答得乱七八糟', effect: { energy: -10, belonging: -2, stress: 14 },
    ...
    },
    {
      ...
      choices: [
        { label: '主动加一句 "我了解你们 graduate sponsor 比例不高"', effect: { energy: -3, academic: 3, stress: 6, flag: 'china_bias_acknowledged' },
        ...
        { label: '装作没注意到 继续答', effect: { energy: -5, belonging: -3, stress: 10 },
  ...
  uni: [
    {
      ...
      choices: [
        { label: '硬着头皮去搭话', effect: { energy: -8, belonging: 3, stress: 5, flag: 'careers_fair_brave' },
        ...
        { label: '只去华人公司摊位（Bytedance / Alibaba UK）', effect: { energy: -3, belonging: 5, stress: 2 },
