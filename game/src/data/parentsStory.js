export const PARENTS_STORY = [
  ...
  },
  {
    ...
    choices: [
      { label: '问爸爸："怎么了"', effect: { energy: -3, belonging: 28, wallet: -180, skipDays: 7, flag: 'parents_uni' },
        feedback: '爸爸沉默了 5 秒。然后说：\n\n"我大学没毕业。"\n\n你愣住。你不知道。\n\n"我考上了。但你爷爷生病。我退学回去打工。" 他擦了一下眼睛 还是看着那块牌匾。"我看你能进这种学校 我心里...就是说不出。"\n\n你妈在旁边没说话。她也擦眼睛。\n\n你站在你爸旁边 也摸了一下那块牌匾。\n\n（这一周景点票 + 餐厅 + 交通你自己掏了大半 · 总计 £180）' },
      { label: '让他自己看一会', effect: { belonging: 15, wallet: -180, skipDays: 7, flag: 'parents_uni' },
