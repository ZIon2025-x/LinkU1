export const STORYLINES = {
  ...
  mei: {
    ...
    chapters: [
      ...
      {
        id: 'mei_4', title: 'Mei 姐 · "对不起 是姐忘了"',
        trigger: { rel: 9, location: 'mei', flag: 'mei_job', minWeek: 18 },
        title_full: 'HMRC 那封棕色信',
        body: '你拿着 HMRC 那封 emergency tax 信去店里。\n\nMei 姐看完愣了 3 秒——然后她"啪"一下把抹布甩到柜台上。\n\n"对不起，是姐忘了。每个新来的小孩第一年都该有 starter checklist 跟 NIN——姐这两年招太多人，搞糊涂了。"\n\n她拉你坐下，从抽屉里翻出一沓表格。',
        choices: [
          { label: '"姐没事的 我去补就行"',
            effect: { rel: 4, wallet: 80, energy: -3, belonging: 14, flag: 'mei_hmrc_helped' },
            feedback: 'Mei 姐：" 不是没事。这是姐的错。" 她当场打了店里会计的电话——电话里全英文,你听了 5 分钟。挂了她跟你说:"会计周末来帮你 GOV.UK 填一遍,姐请客。"\n\n下周末你在店里 PC 跟会计填完 starter checklist。3 周后 HMRC 退给你 £80——但更重要的是,Mei 姐打那通电话时,她左手一直按在你肩膀上,没松。\n\n"以后店里再有新人,你帮我盯一眼这事。" 她说。' },
          { label: '"姐我自己能搞定 别麻烦您"',
            effect: { rel: 1, energy: -5, belonging: 5, flag: 'mei_hmrc_selfsolved' },
            feedback: '你说没事,自己回去填了 GOV.UK。3 周后退到 £80。\n\n你下次去店里时 Mei 姐塞给你一个红包:"£50。不是工资,是姐心里过意不去。" 你推回去 3 次她还是塞给你。\n\n"傻孩子,姐是想说对不起。你不收,姐心里更不舒服。" 你收了。回家路上你想:Mei 姐认错的方式比道歉狠 10 倍。' },
        ],
      },
      {
        id: 'mei_5', title: 'Mei 姐 · "姐其实想回去了"',
        trigger: { rel: 12, location: 'mei', minWeek: 38 },
        title_full: '打烊之后 · 第二次',
        body: '又一次打烊之后。Mei 姐没急着关灯。\n\n她给自己倒了一小杯茅台——你从来没见过她喝。\n\n"姐跟你说个事。我儿子上周打电话来——他爸去年走了你知道吧?——他说我妈一个人在伦敦,你也快 60 了,回来吧。"\n\n她转杯子。"我跟他说我考虑。"',
        choices: [
          { label: '"姐 您想回吗"（直接问）',
            effect: { rel: 5, energy: -3, belonging: 20, flag: 'mei_thinking_of_returning' },
            feedback: 'Mei 姐看你 3 秒。然后说:"想。也不想。"\n\n"我在伦敦 30 年了。这店是我的命。但我儿子说得也对——我老了。"\n\n她喝了一口茅台。"姐没跟任何人说过这事。你是第一个。"\n\n你说不出话。你只是把自己那杯茶推到她面前——示意她也喝点暖的。她笑了——眼眶红。"傻孩子。"\n\n这一刻你跟 Mei 姐之间的关系不一样了——之前你是她照顾的小孩,这一刻她让你看见她也不知道下一步。' },
          { label: '"店还能继续 您舍得吗"（劝她留）',
            effect: { rel: 2, belonging: 10 },
            feedback: 'Mei 姐笑了:"舍得不舍得 那不是我说了算的。腰已经不行了 站一天不行。"\n\n她没继续。你也没继续。两个人坐着喝完那一杯。\n\n临走时她说:"你帮姐保密这事。" 你点头。' },
          { label: '默默听 没说话',
            effect: { rel: 3, belonging: 12 },
            feedback: 'Mei 姐看你一眼,然后笑了:"你这孩子,不爱说话但是听得进去。"\n\n她把茅台又倒了一点。"姐想跟你说一句——你这一年我看着,真的长大了。"\n\n你眼睛一下湿了。她假装没看见,起身去收银台。' },
        ],
      },
    ],
  },
